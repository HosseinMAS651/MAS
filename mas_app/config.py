...
class Settings:
    ...
    recording_bitrate_bps: int
    storage_orphan_grace_seconds: int
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        recording_bitrate_bps=env_int("MAS_RECORDING_BITRATE_BPS", 32000, 8000, 128000),
        storage_orphan_grace_seconds=env_int("MAS_STORAGE_ORPHAN_GRACE_MINUTES", 15, 1, 1440) * 60,
