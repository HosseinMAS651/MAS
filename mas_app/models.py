...
class SpeechFile(Base):
    ...
    speaker_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("speakers.id", ondelete="CASCADE"), nullable=True, index=True
    )
...
class RoomState(Base):
    ...
    # current_index / elapsed_seconds / overtime_seconds are kept for compatibility with old DBs.
