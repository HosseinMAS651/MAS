...
def initialize_database(engine):
    ...
    _add_column_if_missing(engine, "room_states", "overtime_allowed", "BOOLEAN NOT NULL DEFAULT FALSE")
    _add_column_if_missing(engine, "room_states", "completed", "BOOLEAN NOT NULL DEFAULT FALSE")
    ...
    _add_column_if_missing(engine, "room_states", "running", "BOOLEAN NOT NULL DEFAULT FALSE")
