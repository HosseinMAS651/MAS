"""وابستگی‌های FastAPI (Dependencies) برای تزریق امن سرویس‌ها، نشست‌ها و کاربر جاری."""
...
def get_client_ip(
    ...
    return security.extract_client_ip(headers_dict, peer_ip)
...
def get_current_user(
    ...
    """استخراج کاربر احراز هویت شده از کوکی یا هدر Authorization."""
    token = None
    # ۱. بررسی کوکی
    cookie_name = auth_service.settings.cookie_name
    token = request.cookies.get(cookie_name)

    # ۲. بررسی هدر Bearer در صورت عدم وجود کوکی
